...
<html lang="en">
<head>
<img src="iphonexr.jpeg" alt="Apple iPhone XR" width="100" height="100">

<p>iPhone XR Inventory</p>
<h2>Edit Stock</h2>
<p>Type out your new quantity of this product below.</p>

<form action="editiphonexr.php" method = "post">
...
$sql = "SELECT Stock_Key, Creation, Quantity FROM `iPhone XR`";

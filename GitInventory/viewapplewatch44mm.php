...
<html lang="en">
<head>
<img src="applewatch44mm.jpeg" alt="Apple Watch 44mm" width="100" height="100">

<p>Apple Watch 44mm Inventory</p>
<h2>Edit Stock</h2>
<p>Type out your new quantity of this product below.</p>

<form action="editwatch44mm.php" method = "post">
...
$sql = "SELECT Stock_Key, Creation, Quantity FROM `Apple Watch 44mm`";

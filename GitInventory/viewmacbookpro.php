...
<html lang="en">
<head>
<img src="macbookpro.jpeg" alt="Apple Macbook Pro" width="100" height="100">

<p>Macbook Pro Inventory</p>
<h2>Edit Stock</h2>
<p>Type out your new quantity of this product below.</p>

<form action="editmacbookpro.php" method = "post">
...
$sql = "SELECT Stock_Key, Creation, Quantity FROM `Macbook Pro`";

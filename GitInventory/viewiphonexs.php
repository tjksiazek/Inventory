...
<html lang="en">
<head>
<img src="iphonexs.jpeg" alt="Apple iPhone XS" width="100" height="100">

<p>iPhone XS Inventory</p>
<h2>Edit Stock</h2>
<p>Type out your new quantity of this product below.</p>

<form action="editiphonexs.php" method = "post">
...
$sql = "SELECT Stock_Key, Creation, Quantity FROM `iPhone XS`";

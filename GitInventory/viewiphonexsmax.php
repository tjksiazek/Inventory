...
<html lang="en">
<head>
<img src="iphonexsmax.jpeg" alt="Apple iPhone XS MAX" width="100" height="100">

<p>iPhone XS MAX Inventory</p>
<h2>Edit Stock</h2>
<p>Type out your new quantity of this product below.</p>

<form action="editiphonexsmax.php" method = "post">
...
$sql = "SELECT Stock_Key, Creation, Quantity FROM `iPhone XS MAX`";
